...
class ItemControllerTest {
	...
	private void criaDoadorECadastraItens() {
		...
		itemController.cadastrarItem(usuarioController.getUsuario("70513372911"), "colchao", 5, "colchao kingsize,conforto,dormir" );
	...
	private void criaReceptorECadastraItens() {
		...
		itemController.cadastrarItem(usuarioController.getUsuario("84473712044"), "Livro", 1, "Infantil,Matematica,Didatico");
		itemController.cadastrarItem(usuarioController.getUsuario("84473712044"), "Toalha de Banho", 2, "Adulto,TAM G,Azul");
	...
	public void testListarDescritorDeItensParaDoacao() {
		assertEquals("5 - cadeira de rodas | 10 - cobertor | 5 - colchao | 0 - frauda | 0 - livro | 0 - toalha de banho", itemController.listarDescritorDeItensParaDoacao(getTodosItensCadastradosEmDoador()));
	}
	
	@Test
	public void testListarItensParaDoacao() {
		assertEquals("3 - cobertor, tags: [lencol, conforto], quantidade: 10, doador: Elizabeth Ashe/70513372911 | 1 - cadeira de rodas, tags: [roda grande, cadeira], quantidade: 5, doador: Elizabeth Ashe/70513372911 | 2 - colchao, tags: [colchao kingsize, conforto, dormir], quantidade: 5, doador: Elizabeth Ashe/70513372911", itemController.listarItensParaDoacao(this.getTodosItensCadastradosEmDoador()));
	}
	
	@Test
	public void testPesquisarItemParaDoacaoPorDescricao() {
		assertEquals("1 - cadeira de rodas, tags: [roda grande, cadeira], quantidade: 5", itemController.pesquisarItemParaDoacaoPorDescricao("cadeira de rodas", this.getTodosItensCadastradosEmDoador()));
	}
	...
	public void testListarItensNecessarios() {
		assertEquals("4 - livro, tags: [Infantil, Matematica, Didatico], quantidade: 1, Receptor: Murilo Luiz Brito/84473712044 | 5 - toalha de banho, tags: [Adulto, TAM G, Azul], quantidade: 2, Receptor: Murilo Luiz Brito/84473712044 | 6 - frauda, tags: [Higiene, Infantil, P], quantidade: 15, Receptor: Murilo Luiz Brito/84473712044", itemController.listarItensNecessarios(getTodosItensCadastradosEmReceptor()));
	}
}
